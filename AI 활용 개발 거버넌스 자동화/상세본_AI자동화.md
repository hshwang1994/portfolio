...
![AI 개발 거버넌스 harness 전체 구조 — 입력, 검증, 결과, 정책 저장소](AI자동화/arch-overview.png)
...
![코드 한 줄의 검증 과정 (시퀀스)](AI자동화/11-verification-sequence.png)
...
![한 번 겪은 오류를 정책으로 만들어 다음부터 자동 검출](AI자동화/flow-policy.png)
...
![검증 규칙 변경 위험도 3등급 (자동, 승인, 금지)](AI자동화/46-tier-classification.png)
...
![git hook 한 번 설치 후 자동 실행](AI자동화/47-hook-install.png)
...
![커밋 시점 3종 자동 검사](AI자동화/53-commit-boundary.png)
...
![외부 연동은 추측 말고 사람에게 먼저 질의](AI자동화/55-external-contract.png)
...
![Before / After — 사람 검토 의존에서 자동 검증으로](AI자동화/before-after.png)
