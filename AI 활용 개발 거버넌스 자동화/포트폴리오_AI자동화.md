...
![전체 구조 — 입력, 3중 검증 게이트, 결과, 공유 검증 자산](AI자동화/arch-overview-v2.png)
...
![4.6 6단계 거버넌스 파이프라인](AI자동화/46c-governance-pipeline-v2.png)
...
![4.8 AI 협업 워크플로우](AI자동화/48-ai-workflow-v2.png)
